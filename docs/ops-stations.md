...
| 4 | Restaurant Manager.1 | Restaurant Manager | `/ops/manager` | CHIGURU oversight — menu ₹, food bookings, KT/server pulse, food alerts |
...
- Hotel name line, CHIGURU food brand line
